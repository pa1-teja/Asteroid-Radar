...
class AsteroidFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        asteroidViewModel = ViewModelProvider(this,asteroidViewModelFactory).get(AsteroidViewModel::class.java)
...
//                Picasso.get().load(it.hdurl).centerCrop().into(astoridFragmentBinding.imgOfDDay)
            }
        })
